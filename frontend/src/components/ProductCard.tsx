...
const ProductCard = ({
  ...
  return (
    <>
      <div className=' group relative w-[210px] flex flex-1 text-white flex-col max-sm:w-full '>
        <div className='bg-secondary w-[210px] rounded-[2rem] h-[210px] flex justify-center items-center'>
          <img
            src={photo}
            alt='product img'
            className='w-[200px] drop-shadow-2xl h-[200px]'
          />
        </div>
        ...
        <h3 className=' font-palanquin leading-normal text-lg font-semibold mt-[0.3rem]'>
          {name}
        </h3>
        <span className=' text-coral-red font-semibold font-montserrat text-md leading-normal mt-[0.3rem]'>
          {price}
        </span>
        <div className='flex w-[200px] justify-between items-center mt-[0.2rem]'>
